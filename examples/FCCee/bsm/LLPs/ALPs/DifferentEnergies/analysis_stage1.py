...
class Analysis():
    ...
    def __init__(self, cmdline_args):
        ...
        self.input_dir = '/eos/user/c/cdorofee/samples'
        self.output_dir = '/eos/user/c/cdorofee/stage1_output/'
    ...
    def analyzers(self, df):
        ...
        df2 = (
            df
            # TODO: cleanup and label/comment
            ...
            .Define("FSGenPhoton_obj_sel",                                  "MCParticle::sel_pt(0.0)(FSGenPhoton)") 
            .Define("FSGenPhoton_obj_sel_eta",                              "MCParticle::sel_eta(2.5)(FSGenPhoton_obj_sel)") 
            .Define("RecoPhotons_obj_sel",                                  "ReconstructedParticle::sel_pt(0.0)(RecoPhotons)") 
            .Define("RecoPhotons_obj_sel_eta",                              "ReconstructedParticle::sel_eta(2.5)(RecoPhotons_obj_sel)") 
            .Define("FSGenPhoton_eta_obj_sel_eta",                          "MCParticle::get_eta(FSGenPhoton_obj_sel_eta)") 
            .Define("FSGenPhoton_theta_obj_sel_eta",                        "MCParticle::get_theta(FSGenPhoton_obj_sel_eta)")
            .Define("FSGenPhoton_phi_obj_sel_eta",                          "MCParticle::get_phi(FSGenPhoton_obj_sel_eta)") 
            ...
            .Define("n_FSGenPhoton_obj_sel_eta",                            "MCParticle::get_n(FSGenPhoton_obj_sel_eta)") 
            ...
            .Define("RecoPhoton_eta_obj_sel_eta",                           "ReconstructedParticle::get_eta(RecoPhotons_obj_sel_eta)") 
            .Define("RecoPhoton_theta_obj_sel_eta",                         "ReconstructedParticle::get_theta(RecoPhotons_obj_sel_eta)")
            .Define("RecoPhoton_phi_obj_sel_eta",                           "ReconstructedParticle::get_phi(RecoPhotons_obj_sel_eta)") 
            ...
            .Define("RecoPhoton_pidx_min_delta_r_obj_sel_eta",              "ReconstructedParticle::get_pidx_min_delta_r(RecoPhotons_obj_sel_eta)") 
            ...
            .Define("RecoALPPhoton1_obj_sel",                               "ReconstructedParticle::sel_pt(0.0)(RecoALPPhoton1)") 
            .Define("RecoALPPhoton1_obj_sel_eta",                           "ReconstructedParticle::sel_eta(2.5)(RecoALPPhoton1_obj_sel)") 
            .Define("RecoALPPhoton2_obj_sel",                               "ReconstructedParticle::sel_pt(0.0)(RecoALPPhoton2)") 
            .Define("RecoALPPhoton2_obj_sel_eta",                           "ReconstructedParticle::sel_eta(2.5)(RecoALPPhoton2_obj_sel)") 
            ...
            .Define("RecoALP_aa_p_obj_sel_eta",
                                                                            ...
                                                                            "} else { return -2.0f; }") 
            .Define("RecoPhoton_prompt_calorimeter_hit_obj_sel_eta",        "ReconstructedParticle::get_prompt_photon_calorimeter_hits(RecoPhotons_obj_sel_eta)") 
